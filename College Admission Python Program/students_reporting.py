...
class StudentOperations:
    ...
    def verify_students_count(self):
        ...
        while self.valid_count_flag == False and attempts_left != 0:
            self.students_count = int(
                input("Enter the number of students (number must be between 1 and 50, inclusive): "))
    ...
    def accept_student_grades(self):
        ...
        for i in range(0, self.students_count):
            print("Enter marks for " + self.students_list[i].get_first_name() + " " + self.students_list[
                i].get_last_name())
    ...
    def generate_student_reports(self):
        ...
        print("School of Engineering: " + str(engineering_students_percentage) + "%")
        print("School of Business: " + str(business_students_percentage) + "%")
        print("Law School: " + str(law_students_percentage) + "%")
        print("...................................................." + "\n")
